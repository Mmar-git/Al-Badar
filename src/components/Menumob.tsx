  ...
  return (
    <div className="relative">
      <Image
        ...
        width={1200}
        height={1200}
        className="cursor-pointer w-6 h=2"
        onClick={() => setOpen(true)} // Open the menu
      />
      <div
        className={`fixed top-0 left-0 h-full w-[20rem] bg-black text-white p-5 gap-8 text-2xl z-10 transition-all duration-500 ease-in-out transform ${
