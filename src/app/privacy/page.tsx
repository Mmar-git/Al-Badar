  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/privacydesk.jpg')",
        }}
      >
      ...
      <div>
        <div className="py-6">
          <p className="text-xl text-[#FFFFF0] ">
            This Privacy Policy describes how Al Badar collects, uses, and
            discloses your personal information when you visit, use our
            services, or make a purchase from us or otherwise communicate with
            us. For purposes of this Privacy Policy, Our Site identifies you as
        ...
        <div className="py-6">
          ...
          <p className="text-xl text-[#FFFFF0] ">
            ...
            email. <br />- Order information including your name, billing
            address, shipping address, payment confirmation, email address,
            phone number. <br />- Account information including your username,
            password, security questions. <br />- Shopping information including
            the items you view, put in your cart or add to your wishlist. <br />
            ...
            message through the Services. Some features of the Services may
            require you to directly provide us with certain information about
            yourself. You may elect not to provide this information, but doing
        ...
        <div className="py-6">
          ...
          <p className="text-xl text-[#FFFFF0] ">
            ...
            information on our behalf, such as: - Companies who support our Site
            and Services, such as Shopify. - Our payment processors, who collect
            payment information (e.g., bank account, credit or debit card
            information, billing address) to process your payment in order to
            fulfill your orders and provide you with products or services you
            have requested, in order to perform our contract with you. - When
            you visit our Site, open or click on emails we send you, or interact
            with our Services or advertisements, we, or third parties we work
            with, may automatically collect certain information using online
            tracking technologies such as pixels, web beacons, software
        ...
        <div className="py-6">
          ...
          <p className="text-xl text-[#FFFFF0] ">
            ...
            any returns and exchanges and to enable you to post reviews. <br />-
            ...
            <br />- Security and Fraud Prevention. We use your personal
            ...
            contact us immediately. <br />- Communicating with you. We use your
        ...
        <div className="py-6">
          ...
          <p className="text-xl text-[#FFFFF0] ">
            ...
            Policy. Such circumstances may include: - With vendors or other
            third parties who perform services on our behalf (e.g., IT
            management, payment processing, data analytics, customer support,
            cloud storage, fulfillment and shipping). - With business and
            marketing partners, including Shopify, to provide services and
            advertise to you. Our business and marketing partners will use your
            information in accordance with their own privacy notices. - When you
            ...
            your consent. - With our affiliates or otherwise within our
            corporate group, in our legitimate interests to run a successful
            business. - In connection with a business transaction such as a
            merger or bankruptcy, to comply with any applicable legal
            obligations (including to respond to subpoenas, search warrants and
            similar requests), to enforce any applicable terms of service, and
            to protect or defend the Services, our rights, and the rights of our
            users or others. We have, in the past 12 months disclosed the
            following categories of personal information and sensitive personal
            information about users for the purposes set out above in &quot;How
            we Collect and Use your Personal Information&quot; and &quot;How we
            Disclose Personal Information&quot;: Category: - Identifiers such as
            basic contact details and certain order and account information -
            Commercial information such as order information, shopping
            information and customer support information - Internet or other
            similar network activity, such as Usage Data
          </p>
        </div>
        <div className="py-6">
          <h2 className="text-2xl text-bold text-[#B68D3B]">
          ...
          <p className="text-xl text-[#FFFFF0] ">
            ...
            Business and marketing partners - Affiliates We do not use or
            disclose sensitive personal information for the purposes of
            inferring characteristics about you. We have &quot;sold&quot; and
            &quot;shared&quot; (as those terms are defined in applicable law)
            ...
            Category of Personal Information: - Identifiers such as basic
            contact details and certain order and account information -
            Commercial information such as records of products or services
            purchased and shopping information - Internet or other similar
            network activity, such as Usage Data
          </p>
        </div>
        <div className="py-6">
          <h2 className="text-2xl text-bold text-[#B68D3B]">
          ...
          <p className="text-xl text-[#FFFFF0] ">
            ...
            information will respect your privacy or keep it secure. We are not
        ...
        <div className="py-6">
          ...
          <p className="text-xl text-[#FFFFF0] ">
            ...
            Date of this Privacy Policy, we do not have actual knowledge that we
            &quot;share&quot; or &quot;sell&quot; (as those terms are defined in
            applicable law) personal information of individuals under 16 years
            of age.
          </p>
        </div>
        <div className="py-6">
          ...
          <p className="text-xl text-[#FFFFF0] ">
            ...
            retain your personal information depends on different factors, such
            as whether we need the information to maintain your account, to
        ...
        <div className="py-6">
          ...
          <p className="text-xl text-[#FFFFF0] ">
            ...
            permitted by law. - Right to Access / Know. You may have a right to
            ...
            your information. - Right to Delete. You may have a right to request
            that we delete personal information we maintain about you. - Right
            to Correct. You may have a right to request that we correct
            inaccurate personal information we maintain about you. - Right of
            Portability. You may have a right to receive a copy of the personal
            information we hold about you and to request that we transfer it to
            ...
            Site. - Right to Limit and/or Opt out of Use and Disclosure of
            Sensitive Personal Information. You may have a right to direct us to
            limit our use and/or disclosure of sensitive personal information to
            only what is necessary to perform the Services or provide the goods
            reasonably expected by an average individual. - Restriction of
            Processing: You may have the right to ask us to stop or restrict our
            processing of personal information. - Withdrawal of Consent: Where
            we rely on consent to process your personal information, you may
            have the right to withdraw this consent. - Appeal: You may have a
            right to appeal our decision if we decline to process your request.
            You can do so by replying directly to our denial. - Managing
            Communication Preferences: We may send you promotional emails, and
            you may opt out of receiving these at any time by using the
            unsubscribe option displayed in our emails to you. If you opt out,
            we may still send you non-promotional emails, such as those about
            your account or orders that you have made. You may exercise any of
            these rights where indicated on our Site or by contacting us using
            the contact details provided below. We will not discriminate against
            you for exercising any of these rights. We may need to collect
            information from you to verify your identity, such as your email
            address or account information, before providing a substantive
            response to the request. In accordance with applicable laws, You may
        ...
        <div className="py-6">
          <h2 className="text-2xl text-bold text-[#B68D3B]">Complaints:</h2>
          <p className="text-xl text-[#FFFFF0] ">
        ...
        <div className="py-6">
          <h2 className="text-2xl text-bold text-[#B68D3B]">Contact:</h2>
          <p className="text-xl text-[#FFFFF0] ">
            ...
            available to you, please email us at al-badarperfumeries@gmail.com
            or contact us at 38C B.T. Road (Kalpana Apartment), 1st Floor, Flat
            - 1A Kolkata - 700 056, India.
          </p>
        </div>
      </div>
    </div>
