  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/termsdesk.jpg')",
        }}
      >
      ...
      <div>
        <div className="py-6">
          <p className="text-xl text-[#FFFFF0] ">
            This website is operated by Al Badar. Throughout the site, the terms
            “we”, “us” and “our” refer to Al Badar. Al Badar offers this
            ...
            changes. Our store is hosted on Shopify Inc. They provide us with
            the online e-commerce platform that allows us to sell our products
            and Services to you.
          </p>
        </div>
        <div className="py-6">
        ...
        <div className="py-6">
          ...
          <p className="text-xl text-[#FFFFF0] ">
            ...
            our Refund Policy: https://Al Badar.in/pages/refund-policy We have
        ...
        <div className="py-6">
          ...
          <p className="text-xl text-[#FFFFF0] ">
            ...
            For more details, please review our Refund Policy: https://Al
            Badar.in/pages/refund-policy
          </p>
        </div>
        <div className="py-6">
          <h2 className="text-2xl text-bold text-[#B68D3B]">
        ...
        <div className="py-6">
          ...
          <p className="text-xl text-[#FFFFF0] ">
            ...
            governed by our Privacy Policy, which can be viewed here: https://Al
            Badar.in/pages/privacy-policy
          </p>
        </div>
        <div className="py-6">
          <h2 className="text-2xl text-bold text-[#B68D3B]">
        ...
        <div className="py-6">
          ...
          <p className="text-xl text-[#FFFFF0] ">
            ...
            case shall Al Badar, our directors, officers, employees, affiliates,
        ...
        <div className="py-6">
          ...
          <p className="text-xl text-[#FFFFF0] ">
            You agree to indemnify, defend and hold harmless Al Badar and our
        ...
        <div className="py-6">
          ...
          <p className="text-xl text-[#FFFFF0] ">
            ...
            al.badarperfumeries@gmail.com. Our contact information is posted
            below: Al Badar al-badarperfumeries@gmail.com 38C B.T. Road (Kalpana
            Apartment), 1st Floor, Flat - 1A Kolkata - 700 056, India.
          </p>
        </div>
      </div>
    </div>
